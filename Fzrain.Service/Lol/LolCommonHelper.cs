   ...
   internal  class LolCommonHelper
    {
       ...
       public  static Battle GetDataByIdV2(int id,int areaId)
       {
        ...
        public static List<int> GetGameIds(string qq, int areaId)
        {
            ...
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create("http://api.pallas.tgp.qq.com/core/tcall?callback=getGameDetailCallback&dtag=profile&p=" + p + "&t=1417937593108");
            request.Method = "Get";
            request.Headers.Add(HttpRequestHeader.Cookie, "pgv_pvid=219706695; pt2gguin=o0250970574; RK=re3LT0wkGY; ptcz=2f0439abda0979a7efd95ca2ea2e376a6ff344ced275740021b85762766c75b1; pgv_pvi=2879912960; ac=1,006,008; pgv_si=s6238680064; pgv_info=ssid=s1862081788; puin=250970574; pkey=00015498096E0070D03E1617CBFC2DE3EBDD3669A8B6899A20FF97032AC1CE89907B4A4F08422262123A62699020DB1547644DE295752289B8D6853E5E2A6BE7F6564C15B204B6E748AC5961CE49B62FE51C112AE4F34D859F00952B787C7930D4F35AE9D71F243E0240E01BDB3CC2CE53246B2631E8CFD3; aid=11; uname=");
